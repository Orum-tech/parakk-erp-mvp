      ...
      return Scaffold(
        appBar: AppBar(
          title: Column(
            ...
            children: [
              Text(widget.teacherName, style: const TextStyle(color: Colors.black, fontSize: 16)),
              Text("Class Teacher", style: const TextStyle(color: Colors.grey, fontSize: 12)),
            ],
          ),
        ...
        actions: [
          if (widget.teacherEmail != null)
            IconButton(
              ...
              onPressed: () async {
                final email = widget.teacherEmail!;
